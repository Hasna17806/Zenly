...
const ChallengesPage = () => {
  ...
  const allChallenges = {
    'Mood Boost': [
      ...
      },
      {
        ...
        time: '2 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495619/Businessman_s_Idea__A_Creative_Concept-removebg-preview_aclfa2.png',
      ...
      },
      {
        ...
        time: '3 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776492892/download-removebg-preview_rcmcub.png',
      ...
      },
      {
        ...
        time: '3 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776492888/download__1_-removebg-preview_s5n28a.png',
      ...
      },
      {
        ...
        time: '5 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776492885/Screenshot_2026-04-18_112558-removebg-preview_fw4jwy.png',
        moodTag: ['stressed/Heavy', 'angry/Frustrated', 'Overthinking'],
        gameType: 'color-calm',
      },
      {
        ...
        time: '5 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776492877/download__2_-removebg-preview_ooacy4.png',
    ...
    'Study': [
      ...
      },
      {
        id: 'speed-sort',
        title: 'Speed Sort',
        description: 'Sort items quickly to train your brain',
        time: '3 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495615/sticker_yellow___Tendo_ideia_emoticon_amarelo_personagem_de_desenho_animado_fundo_branco_s__-removebg-preview_o12wz8.png',
        moodTag: ['happy/Energetic', 'calm/Okay'],
        gameType: 'speed-sort',
      },
      {
        id: 'recall-rush-quick',
        title: 'Recall Rush',
        description: 'Quick memory test',
        time: '1 min',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495615/Canal_do_WhatsApp-removebg-preview_amtf4e.png',
        moodTag: ['happy/Energetic', 'calm/Okay'],
        gameType: 'recall-rush',
      },
       {
        id: 'one-shot-math-quick',
        title: 'One Shot Math',
        description: 'Quick math challenge',
        time: '1 min',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495641/Product_Design_vs_Product_Management-removebg-preview_qgtxdf.png',
        moodTag: ['happy/Energetic', 'calm/Okay'],
        gameType: 'one-shot-math',
      },
    ...
    'Fun': [
      ...
      {
        id: 'meme-reaction-fun',
        title: 'Meme Reaction',
        description: 'Quick reactions to funny memes',
        time: '2 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495616/download__4_-removebg-preview_bepfgu.png',
        moodTag: ['happy/Energetic', 'sad/Low'],
        gameType: 'meme-reaction',
      },
      {
        id: 'guess-sound',
        ...
        time: '3 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495615/Strichm%C3%A4nnchen-Bilder__Stock-Fotos___-Videos_-removebg-preview_rrpsvz.png',
        moodTag: ['happy/Energetic', 'calm/Okay'],
        gameType: 'sound',
      },
      {
        id: 'catch-the-mood',
        title: 'Catch the Mood',
        description: 'Tap the moving emoji to catch the right mood',
        time: '30 secs',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495621/download__6_-removebg-preview_f6rtk2.png',
        moodTag: ['happy/Energetic', 'sad/Low', 'stressed/Heavy'],
        gameType: 'catch-the-mood',
      },
    ],
    'Quick Play': [
      {
      ...
      },
      {
        ...
        time: '30 secs',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495619/download__7_-removebg-preview_1_uckkwn.png',
      ...
      },
      {
        id: 'tap-rush-quick',
        title: 'Tap Rush',
        description: '30 seconds of fast tapping fun',
        time: '30 secs',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495665/download__9_-removebg-preview_wpedp9.png',
        moodTag: ['angry/Frustrated', 'stressed/Heavy', 'happy/Energetic'],
        gameType: 'tap-rush',
      },
       {
        id: 'spin-smile',
        ...
        time: '1 min',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495622/Download_3D_Lucky_Wheel_roulette_lucky_prize_Illustration_for_free-removebg-preview_skffcx.png',
      ...
      },
      {
        id: 'flash-memory',
        title: 'Flash Memory',
        description: 'Remember patterns in a flash',
        time: '2 mins',
        image: 'https://res.cloudinary.com/dkqjn6dqw/image/upload/q_auto/f_auto/v1776495656/Autism_free_icons_designed_by_Karyative-removebg-preview_yrcj8l.png',
        moodTag: ['happy/Energetic', 'calm/Okay'],
        gameType: 'flash-memory',
      },
  ...
  const handlePlayChallenge = (challenge) => {
    const routes = {
      ...
      'recall-rush': '/games/weird-quiz',
      'one-shot-math': '/games/brain-sprint',
      'flash-memory': '/games/mini-memory',
      'speed-sort': '/games/word-builder',
      ...
      'tap-rush': '/games/tap-burst',
      'meme-reaction': '/games/meme-reaction',
      'catch-the-mood': '/games/catch-the-mood',  // ← NEW ROUTE
